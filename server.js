...
const TOTAL_CONCURRENCY = parseInt(process.env.TOTAL_CONCURRENCY) || 100;   // total parallel requests
const PARALLEL_EXAMINERS = parseInt(process.env.PARALLEL_EXAMINERS) || 1;   // how many examiners to attack simultaneously
const REQUEST_TIMEOUT = parseInt(process.env.REQUEST_TIMEOUT) || 5000;       // 3 seconds
